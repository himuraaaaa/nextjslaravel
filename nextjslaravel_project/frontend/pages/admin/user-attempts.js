                ...
                <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                                ...
                                <table className="min-w-full bg-white border border-gray-300">
                                    <thead>
                                        <tr className="bg-gray-50">
                                            ...
                                            <th className="px-4 py-2 border">Started</th>
                                    ...
                                    <tbody>
                                        {userAttempts.attempts.map((attempt) => (
                                            <tr key={attempt.id} className="hover:bg-gray-50">
                                                <td className="px-4 py-2 border text-center">{attempt.attempt_number}</td>
                                                <td className="px-4 py-2 border text-center">
                                                    <span className={`px-2 py-1 rounded text-xs ${
                                                        attempt.status === 'completed' ? 'bg-green-100 text-green-800' :
                                                        attempt.status === 'started' ? 'bg-yellow-100 text-yellow-800' :
                                                        'bg-red-100 text-red-800'
                                                    }`}>
                                                        {attempt.status}
                                                    </span>
                                                </td>
                                                <td className="px-4 py-2 border text-center">{attempt.score}%</td>
                                                <td className="px-4 py-2 border text-center">
                                                ...
                                                <td className="px-4 py-2 border text-center">
                                                    {attempt.completed_at ? 
                                                        Math.round((new Date(attempt.completed_at) - new Date(attempt.started_at)) / 1000 / 60) + ' min' : 
                                                        '-'
                                                    }
                                                </td>
                                            </tr>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <h3 className="font-semibold text-gray-800">Reset Attempts</h3>
